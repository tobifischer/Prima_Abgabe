...
(function (FudgeKart) {
    ...
    })(ANGLE = FudgeKart.ANGLE || (FudgeKart.ANGLE = {}));
    let JOB;
    (function (JOB) {
        JOB[JOB["IDLE"] = 0] = "IDLE";
        JOB[JOB["PATROL"] = 1] = "PATROL";
    })(JOB = FudgeKart.JOB || (FudgeKart.JOB = {}));
    class Enemy extends ƒ.Node {
        constructor(_name = "Enemy", _position) {
            ...
            let cmpStateMachine = new FudgeKart.ComponentStateMachineEnemy();
        ...
        update() {
            this.getComponent(FudgeKart.ComponentStateMachineEnemy).act();
        ...
        chooseTargetPosition() {
            let range = FudgeKart.sizeWall * FudgeKart.numWalls / 2 - 2;
        ...
        displayAnimation() {
            this.show.mtxLocal.showTo(ƒ.Vector3.TRANSFORMATION(FudgeKart.avatar.mtxLocal.translation, this.mtxWorldInverse, true));
